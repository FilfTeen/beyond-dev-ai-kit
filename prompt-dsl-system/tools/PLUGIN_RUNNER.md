...
```text
HONGZHI_GOV_BLOCK code=<10|11|12> reason=<...> command=<...> detail="..."
```
...
```text
HONGZHI_CAPS <abs_path_to_capabilities.json>
```

2. workspace append-only summary journal:
...
3. capability files on successful run:
